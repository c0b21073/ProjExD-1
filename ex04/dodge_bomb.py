...
def main():
    ...
    while True:
        ...
        if key_list[pg.K_UP]: tori_rct.centery -= 1
        if key_list[pg.K_DOWN]: tori_rct.centery += 1
        if key_list[pg.K_RIGHT]: tori_rct.centerx += 1
        if key_list[pg.K_LEFT]: tori_rct.centerx -= 1
